...
public class ResizeHelper {
    ...
    public static void addResizeListener(Stage stage, double minWidth, double minHeight, double maxWidth, double maxHeight) {
        ...
        stage.getScene().addEventHandler(MouseEvent.MOUSE_RELEASED, mouseEvent -> {
            if (mouseEvent.getButton().equals(MouseButton.PRIMARY)) {
                ((CustomStage) stage).setResizing(false);
            }
        });
    ...
    private static void addListenerDeeply(Node node, EventHandler<MouseEvent> listener) {
        ...
        node.addEventHandler(MouseEvent.MOUSE_RELEASED, mouseEvent -> {
            if (mouseEvent.getButton().equals(MouseButton.PRIMARY)) {
                ((CustomStage) node.getScene().getWindow()).setResizing(false);
            }
        });
